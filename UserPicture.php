...
if (isset($_POST['submit']) && isset($_FILES['picture1'])) {
  ...
  if (move_uploaded_file($t_name, "images/" . $f_name)) {
...
if (isset($_POST['submit']) && isset($_FILES['picture2'])) {
  ...
  if (move_uploaded_file($t_name, "images/" . $a_name)) {
...
if (isset($_POST['submit']) && isset($_FILES['picture3'])) {
  ...
  if (move_uploaded_file($t_name, "images/" . $h_name)) {
    // echo "file move";
  } else {
    // echo " file not moved";
  }
...
if (isset($_POST['submit']) && isset($_FILES['picture4'])) {
  ...
  if (move_uploaded_file($t_name, "images/" . $s_name)) {
    // echo "file move";
  } else {
    // echo " file not moved";
  }
